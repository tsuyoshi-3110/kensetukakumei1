...
class JyudakuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //カスタムセルを登録する
        let nib = UINib(nibName: "JyudakuTableViewCell", bundle: nil)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if Auth.auth().currentUser != nil {
            ...
            if listener == nil {
                ...
                let postsRef = Firestore.firestore().collection(Const.PostOenPath).whereField("youseiFlag", isEqualTo: false).order(by: "date", descending: true)
      ...
      func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
          // セルを取得してデータを設定する
          let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! JyudakuTableViewCell
